%% main function
function cameraIntrinsicPropertiesCal_V2()
    clear all;
    ...
    syms focal_length lcw delta_theta;
    multi_variable = [focal_length; lcw];
    ...
    comat_left_and_right = [comat_left_x; comat_left_y; comat_right_x; comat_right_y];

    zdudv_left_and_right = [zdu_left; zdv_left; zdu_right; zdv_right];

    multi_variable = linsolve(comat_left_and_right, zdudv_left_and_right);
    focal_length = multi_variable(1);
    lcw = multi_variable(2);
    ...
    delta_theta = (delta_theta_left + delta_theta_right) / 2;
    ...
    focal_length_est = (focal_length_left_x_est + focal_length_left_y_est +...
                       focal_length_right_x_est + focal_length_right_y_est) / 4;
                   
    lcw_est = (lcw_left_x_est + lcw_left_y_est + lcw_right_x_est + lcw_right_y_est) / 4;
    
    
    % solve delta_theta_left_x
    [cos_delta_theta_left_x, sine_delta_theta_left_x] = getDeltaTheta(focal_length_est, lcw_est,...
    dx_vec, du_left, dv_left, zdu_left, zdv_left, 'x');

     % solve delta_theta_left_y
    [cos_delta_theta_left_y, sine_delta_theta_left_y] = getDeltaTheta(focal_length_est, lcw_est,...
    dy_vec, du_left, dv_left, zdu_left, zdv_left, 'y');
     
     % solve delta_theta_right_x
    [cos_delta_theta_right_x, sine_delta_theta_right_x] = getDeltaTheta(focal_length_est, lcw_est,...
    dx_vec, du_right, dv_right, zdu_right, zdv_right, 'x');

     % solve delta_theta_right_y
    [cos_delta_theta_right_y, sine_delta_theta_right_y] = getDeltaTheta(focal_length_est, lcw_est,...
    dy_vec, du_right, dv_right, zdu_right, zdv_right, 'y');
    
    
%     % solve delta_theta_left_x
%     [delta_theta_left_x_vec, delta_theta_left_x] = getDeltaTheta(focal_length, lcw,...
%                 dx_vec, du_left, dv_left, zdu_left, zdv_left, 'x');
% 
%     % solve delta_theta_left_y
%     [delta_theta_left_y_vec, delta_theta_left_y] = getDeltaTheta(focal_length, lcw,...
%                 dy_vec, du_left, dv_left, zdu_left, zdv_left, 'y');
%     
%     % solve delta_theta_right_x
%     [delta_theta_right_x_vec, delta_theta_right_x] = getDeltaTheta(focal_length, lcw,...
%                 dx_vec, du_right, dv_right, zdu_right, zdv_right, 'x');
% 
%     % solve delta_theta_right_y
%     [delta_theta_right_y_vec, delta_theta_right_y] = getDeltaTheta(focal_length, lcw,...
%                 dy_vec, du_right, dv_right, zdu_right, zdv_right, 'y');
